...
public class NullExpression<AT extends Type, ET extends Type> extends Expression<ET>{
	
	public NullExpression(Expression<? super EntityLiteral> arg, SourceLocation location) throws IllegalArgumentException{
		super(location);
	}
