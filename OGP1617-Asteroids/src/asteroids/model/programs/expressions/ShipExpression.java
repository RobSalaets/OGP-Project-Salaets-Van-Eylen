...
public class ShipExpression<AT extends Type, ET extends Type> extends Expression<ET>{
	
	public ShipExpression(Expression<? super ShipEntity> arg, SourceLocation location) throws IllegalArgumentException{
		super(location);
	}
